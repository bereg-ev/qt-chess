...
void Test::testPawn()
{
    ...
    myAssert(306, moves13.movesv.size() == 16);
    ...
    myAssert(310, moves17.movesv.size() == 4);
    ...
    myAssert(311, moves18.movesv.size() == 8);
}
...
void Test::testCastle()
{
    ...
    MoveGen moves2 = MoveGen(board2, NO_DEBUG, 1);
    myAssert(603, moves2.movesv.size() == 14);
    ...
    MoveGen moves5 = MoveGen(board5, NO_DEBUG, 1);
    myAssert(609, moves5.movesv.size() == 14);
    ...
    MoveGen moves8 = MoveGen(board8, NO_DEBUG, 1);
    myAssert(615, moves8.movesv.size() == 15);
    ...
    MoveGen moves15 = MoveGen(board15, NO_DEBUG, 1);
    myAssert(621, moves15.movesv.size() == 15);
    ...
    myAssert(631, moves26.movesv.size() == 4);
...
void Test::testIfCheck()
{
    ...
    myAssert(1000, moves1a.movesv.size() != moves1b.movesv.size());             // check if King escapes from the actual Check

    Board board2("........ .......Q ........ .K...... ........ ........ .....p.. ......k.", "033");
    MoveGen moves2a = MoveGen(board2, NO_DEBUG, 1);
    MoveGen moves2b = MoveGen(board2, CHECK_VALIDITY, 1);
    myAssert(1001, moves2a.movesv.size() != moves2b.movesv.size());             // check if King moves into a Check

    Board board3("........ P....... ........ .....K.. ........ ........ ........ .....qk.", "033");
    MoveGen moves3a = MoveGen(board3, NO_DEBUG, 1);
    MoveGen moves3b = MoveGen(board3, CHECK_VALIDITY, 1);
    myAssert(1002, moves3a.movesv.size() != moves3b.movesv.size());             // check if we can hit the King
